...
resource "aws_cloudfront_distribution" "s3_distribution" {
  origin {
    domain_name = aws_s3_bucket_website_configuration.advent-calendar-website-config.website_endpoint
...
resource "aws_cloudfront_origin_request_policy" "advent_calendar_origin_request_policy" {
  name = "advent-calendar-forward-cookies"
